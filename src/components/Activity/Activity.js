                                        ...
                                        <table className="min-w-full leading-normal">
                                            <thead>
                                                <tr className="heading-row-table">
                                                    <th
                                                        className="px-5 py-3 text-center text-lg  font-semibold text-gray-600 uppercase tracking-wider table-heading">
                                            ...
                                            <tbody className="data-row">
                                                <tr>
                                                    <td className="px-5 py-5 bg-white text-sm w-2/5">
                                                        <div className="flex items-center">
                                                            {/* <div className="flex-shrink-0 w-30 h-30 hidden sm:table-cell">
                                                                <img className="w-full h-full rounded-full"
                                                                    src="https://images.unsplash.com/photo-1601046668428-94ea13437736?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=2167&q=80"
                                                                    alt="" />
                                                            </div> */}
                                                            <div className="ml-3">
                                                                <p className="text-gray-900 whitespace-no-wrap nft-name">
                                                                    Sales
                                                                </p>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <td className="px-5 bg-white text-sm ">
                                                        <div className="flex justify-center items-center">
                                                            <div className="flex-shrink-0 w-45 h-45 hidden sm:table-cell">
                                                                <img className="w-full h-full rounded-2"
                                                                    src={nft1}
                                                                    alt="" />
                                                            </div>
                                                            <div className="ml-10">
                                                                <p className="text-gray-900 whitespace-no-wrap text-right nft-name text-lg">
                                                                    Bareblockclub#01
                                                                </p>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <td className="px-5 bg-white text-sm">
                                                        <p className="text-gray-900 whitespace-no-wrap text-right flex text-lg">
                                                        ...
                                                        <p className="text-gray-900 whitespace-no-wrap text-right flex justify-end">
                                                            <span>$31.43</span>
                                                        </p>
                                                    </td>
                                                    <td className="px-5 bg-white text-sm w-2/5">

                                                        <p className="text-gray-900  text-center whitespace-no-wrap  nft-name text-lg ">
                                                            <span>1</span>
                                                    ...
                                                    <td className="px-5 bg-white text-sm w-2/5">
                                                        ...
                                                        <p className="text-gray-900  text-center whitespace-no-wrap  text-lg nft-user">
                                                            <span>5YpYEE</span>
                                                    ...
                                                    <td className="px-5   bg-white text-sm w-2/5">
                                                        ...
                                                        <p className="text-gray-900  text-center whitespace-no-wrap text-lg nft-name">
                                                ...
                                                <tr>
                                                    <td className="px-5 py-3 bg-white text-sm w-2/5">
                                                        <div className="flex items-center">
                                                            {/* <div className="flex-shrink-0 w-30 h-30 hidden sm:table-cell">
                                                                <img className="w-full h-full rounded-full"
                                                                    src="https://images.unsplash.com/photo-1601046668428-94ea13437736?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=2167&q=80"
                                                            ...
                                                            <div className="ml-3">
                                                                <p className="text-gray-900 whitespace-no-wrap nft-name  text-center">
                                                                    Sales
                                                                </p>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <td className="px-5  bg-white  text-center text-sm w-2/5">
                                                        <p className="text-gray-900 whitespace-no-wrap text-lg nft-user">
                                                            6eAoxc
                                                        </p>
                                                    </td>
                                                    <td className="px-5   bg-white text-sm w-2/5">
                                                ...
                                                <tr>
                                                    <td className="px-5 py-5 bg-white text-sm w-2/5">
                                                        <div className="flex items-center">
                                                            ...
                                                            <div className="ml-3">
                                                                <p className="text-gray-900  text-center whitespace-no-wrap nft-name">
                                                                    List
                                                                </p>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <td className="px-5 bg-white text-sm w-2/5">
                                                        ...
                                                        <p className="text-gray-900 whitespace-no-wrap  text-center text-lg nft-user">
                                                            <span>5YpYEE</span>
                                                    ...
                                                    <td className="px-5   bg-white text-sm w-2/5">
                                                        ...
                                                        <p className="text-gray-900 whitespace-no-wrap  text-center text-lg nft-name">
                                                            <span>2 miniutes Ago</span>
                                                ...
                                                <tr>
                                                    ...
                                                    <td className="px-5  bg-white text-sm w-2/5">
                                                        <p className="text-gray-900 whitespace-no-wrap text-lg  text-center nft-user">
                                                            6eAoxc
                                                        </p>
                                                    </td>
                                                    <td className="px-5   bg-white text-sm w-2/5">
                                                ...
                                                <tr>
                                                    ...
                                                    <td className="px-5  bg-white text-sm w-2/5">
                                                        <p className="text-gray-900 whitespace-no-wrap text-lg nft-user  text-center">
                                                            6eAoxc
                                                        </p>
                                                    </td>
                                                    <td className="px-5   bg-white text-sm w-2/5">
