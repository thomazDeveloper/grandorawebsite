...
const GameItem = (props: any) => {
  ...
  return (
    ...
    >
      ...
      <div className="m-6p">
        <p className="text-8 md:text-14 uppercase font-semibold md:leading-16 leading-10 tracking-3p">
          mini game grando
        </p>
        <p className="text-8 md:text-14 uppercase font-semibold md:leading-16 tracking-3p">
          {item.title}
        </p>
