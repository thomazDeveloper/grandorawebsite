...
const NewsSlide = () => {
  const slideClass = {
    ...
    title:
      "uppercase py-5p sm:text-34 tracking-20p  text-16 font-Rajdhani text-davygrey  text-montserrat",
    description:
  ...
  return (
    <div className={slideClass.contain} id="newsSlide">
      ...
      <p className="uppercase sm:text-21 text-12 sm:leading-26 tracking-10p font-Rajdhani font-semibold text-davygrey py-5p">
        <FontAwesomeIcon
          icon={faAngleRight}
