  ...
  return (
    <div key={num} className="flex mb-72 flex-col sm:flex-row">
      ...
      <div className=" sm:mr-50 sm:ml-10 ml-[43px] sm:mt-0 mt-[-27px]">
        <p className="sm:text-25 text-14 font-Rajdhani text-cloudygrey font-medium uppercase">
          {data.step}
        </p>
        <p className="sm:text-42 text-[22px] font-Hanno text-davygrey font-medium whitespace-nowrap">
          {data.date}
        </p>
      </div>
      <div className="sm:text-17 text-[14px] font-Rajdhani text-davygrey sm:ml-0 ml-40">
