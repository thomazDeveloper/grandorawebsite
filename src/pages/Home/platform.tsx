...
const Platform = () => {
  return (
    <div>
      <div className="uppercase leading-56 text-davygrey font-Hanno platform_windows platform_mobiles">
        <p className="p-1">The platform where</p>
        <p className="text-texasRose p-1">everyone can be anything</p>
        {/* <p className="p-1 text-20">LIMITLESS POSSIBILITY VERSE</p> */}
      </div>
    </div>
    // <div
    //   id="platform"
    ...
    //       <div className="text-[10px] sm:text-18 font-lato">
    //         <p>LIMITLESS</p>
    //         <p>POSSIBILITY VERSE</p>
    //       </div>
    //     </div>
    //     <a href="/map" target="_blank" rel="noopener noreferrer">
    //     <button className="hidden md:block bg-texasRose font-Rajdhani font-semibold text-white hover:text-primary border border-texasRose h-30 w-197 text-14 uppercase tracking-20p mt-23 lg:ml-100 rounded-6">
    ...
    //   </div>
    //   <a href="/map" target="_blank" rel="noopener noreferrer">
    //   <button className="block md:hidden bg-texasRose font-Rajdhani font-semibold  text-white hover:text-primary border border-texasRose h-35 w-220 text-14 uppercase tracking-20p my-50p rounded-6 mx-auto">
    //     <FontAwesomeIcon icon={faFile} className="mr-7" /> whitepaper
    //   </button>
    //   </a>
    // </div>
