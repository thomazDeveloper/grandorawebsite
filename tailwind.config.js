  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        mnp: "1px 2px 4px rgba(128, 124, 118, 0.25)", // mobile nft product
      ...
      borderRadius: {
        ...
        mnp: "2px 2px 15px 15px" //mobile nft product
      },
      borderWidth: {
        default: "0.5px",
        0: "0px",
    ...
    backgroundImage: {
      ...
      centralhub2: "url('./assets/images/landmobile.jpg');",
